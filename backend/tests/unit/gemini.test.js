import { generateExplanation } from '../../src/services/explanation.service.js';
import * as geminiConfig from '../../src/config/gemini.config.js';

// Mock the Gemini config to pretend it's disabled for the fallback test
jest.mock('../../src/config/gemini.config.js', () => ({
...
describe('Gemini Explanation Service (Fallback Mode)', () => {
  const mockRecommendation = {
    ...
    alternativeGate: { gateId: 'gate_b', gateName: 'East Gate', walkingTimeMins: 10, waitingTimeMins: 5 },
    safetyScore: 90,
    confidenceScore: 95,
