    ...
    <Fade in={true} timeout={1000}>
      <Paper elevation={0} sx={{ p: 4, borderRadius: 4, border: `1px solid ${theme.palette.divider}`, height: '100%' }}>
        <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }} mb={3}>
          ...
          <Box>
            <Typography variant="h6" fontWeight={700}>Gemini AI Analysis</Typography>
            <Typography variant="caption" color="text.secondary">Generated in real-time from deterministic models</Typography>
          </Box>
        </Stack>
        ...
        <Box mb={3}>
          <Typography variant="subtitle2" fontWeight={700} gutterBottom>Detailed Reasoning</Typography>
