    ...
    <Box sx={{ width: '100%', maxWidth: 1200, mx: 'auto', p: 3 }}>
      <Stack spacing={3} sx={{ alignItems: 'center' }} mb={6}>
        ...
        <Typography variant="h6" color="text.secondary">
          AI Decision Engine is calculating the optimal route...
        </Typography>
      </Stack>
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" color="error.main" mb={4}>
          {message ||
            'The AI Decision Engine encountered an error or all gates are currently marked unsafe.'}
        </Typography>
        <Button
          variant="contained"
          color="error"
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary" mb={4}>
          The AI Decision Engine is standing by. Generate a recommendation to see the optimal,
          safest gate for your stadium entry based on real-time data.
        </Typography>
        <Button
          variant="contained"
          size="large"
