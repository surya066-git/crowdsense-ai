...
const benefits = [
  {
    title: 'Save Time',
    desc: 'No more waiting in massive queues at the wrong gate.',
    icon: FiClock,
  },
  {
    title: 'Avoid Crowds',
    desc: 'Real-time density tracking keeps you away from bottlenecks.',
    icon: FiUsers,
  },
  {
    title: 'Safe Entry',
    desc: 'Prioritize safety with intelligent routing during emergencies.',
    icon: FiShield,
  },
  {
    title: 'AI Powered',
    desc: 'State-of-the-art predictive models personalize your experience.',
    icon: FiCpu,
  },
];
        ...
        <Grid container spacing={8} sx={{ alignItems: 'center' }}>
          <Grid xs={12} md={5}>
            ...
            <Typography variant="subtitle1" color="text.secondary" mb={4}>
              We are redefining the stadium experience by putting intelligent decision-support
