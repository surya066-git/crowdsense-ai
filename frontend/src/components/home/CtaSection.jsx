        ...
        >
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            <Typography variant="subtitle1" sx={{ opacity: 0.9, mb: 6, maxWidth: 600, mx: 'auto' }}>
              Join thousands of fans using CrowdSense AI to navigate stadiums safely and efficiently. Start your interactive demo now.
            </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ justifyContent: 'center' }}>
              <Button 
                ...
                sx={{ 
                  ...
                  px: 4, py: 1.5, borderRadius: '50px', fontWeight: 700 
                }}
              >
                Start Demo
              </Button>
              <Button 
                ...
                sx={{ 
                  ...
                  px: 4, py: 1.5, borderRadius: '50px', fontWeight: 600 
                }}
              >
                Learn More
              </Button>
